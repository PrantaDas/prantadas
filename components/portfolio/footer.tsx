    ...
    <footer className="relative border-t border-white/5 overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Brand column */}
          <div>
            <div className="font-display font-bold text-white/80 text-lg mb-2">Pranta Das</div>
            <p className="text-xs text-white/30 font-mono leading-relaxed mb-4 max-w-[200px]">
              Backend developer building scalable systems from Dhaka, Bangladesh.
            </p>
          ...
          {/* Navigation column */}
          <div>
            <div className="text-xs font-mono text-white/30 uppercase tracking-widest mb-4">Navigation</div>
            <nav className="grid grid-cols-2 gap-x-4 gap-y-2" aria-label="Footer navigation">
              ...
              <Link href="/blog" className="text-sm text-white/35 hover:text-primary transition-colors font-mono flex items-center gap-1.5">
          ...
          {/* Built with column */}
          <div>
            <div className="text-xs font-mono text-white/30 uppercase tracking-widest mb-4">Built with</div>
